...
params = {
	...
	"daily": ["temperature_2m_max", "temperature_2m_min", "snowfall_sum", "uv_index_max", "wind_speed_10m_max", "weather_code"],
...
daily_dataframe.to_csv("/Users/xavierrudnick/Desktop/softDev/CSCI3308-014-02-Group-Project/ProjectSourceCode/Api_Implementation/output/copper_daily_weather.csv", index=False)
